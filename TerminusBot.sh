...
#=========HEADER===========================================================|
#AUTOR
# Email: Alan Mendes <alan80mendes@gmail.com>
# Telegram: https://t.me/maanager
#PROGRAMA
#Script para ativação e controle do do Bot para TELEGRAM E WHATSAPP
#
#==========================================================================|
...
clear
#============================== COLUNA 1 ================================================|
echo -e 'BOT VENDAS' | figlet -f small | lolcat
echo " "
tput sgr0
echo " "
tput cup 4 1
...
tput sgr0
tput cup 10 1
echo "${Red}[${Norm}${Bold}7${Norm}${Red}]${Norm} ${Yellow}${Bold}LINK PAINEL WEB${Norm}${Norm} [${Green}${revenda_vazio}${Norm}]" 
tput sgr0
tput cup 11 1
echo "${Red}[${Norm}${Bold}8${Norm}${Red}]${Norm} ${Yellow}${Bold}LINK DE SUPORTE${Norm}${Norm} [${Green}${suporte_vazio}${Norm}]"   
tput sgr0
tput cup 12 1
echo "${Red}[${Norm}${Bold}9${Norm}${Red}]${Norm} ${Yellow}${Bold}DOWNLOAD APLICATIVOS${Norm}${Norm} [${Green}${link_vazio}${Norm}]"   
tput sgr0


#================================== COLUNA 2 ================================================|
tput cup 4 36
echo "${Red}[${Norm}10${Red}]${Norm} ${Yellow}${Bold}VALIDADE DA  CONTA${Norm}${Norm} [${Green}${validade_conta_vazio}${Norm}]"  
tput sgr 0
tput cup 5 36
echo "${Red}[${Bold}${Norm}11${Red}]${Norm} ${Yellow}${Bold}DURAÇÃO DO TESTE${Norm}${Norm} [${Green}${test_vazio}${Norm}]"
tput sgr0
tput cup 6 36
echo "${Red}[${Norm}${Bold}12${Norm}${Red}]${Norm} ${Yellow}${Bold}VALOR DA CONTA${Norm}${Norm} [${Green}${valor_vazio}${Norm}]"
tput sgr0
tput cup 7 36
echo "${Red}[${Norm}${Bold}13${Norm}${Red}]${Norm} ${Yellow}${Bold}ACESSOS POR CONTA${Norm}${Norm} [${Green}${acesso_vazio}${Norm}]"
tput sgr0
tput cup 8 36
echo "${Red}[${Norm}${Bold}14${Norm}${Red}]${Norm} ${Yellow}${Bold}ADICIONAR SEGUNDA CONTA${Norm}${Norm} [${Green}${extendido_vazio}${Norm}]"
tput sgr0
tput cup 9 36
...
link_suporte(){
  ...
  echo "${Cyan}Ex: https//:t.me/LOCKED_SSH${Norm}"
  read -p ":> " link
